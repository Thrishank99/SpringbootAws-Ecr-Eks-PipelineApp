...
public class EmployeeController {
	...
	public String welcomeTest() {
		...
		return "WELCOME TO SPRING BOOT, TO DEPLOY SPRING APPLICATION ON AWS BY USING ECR(ELASTIC CONTAINER REGISTRY) AND ECS(ELESTIC CONTAINER SERVICE) BY SUPPORTING AWS CODEBUILD AND AWS CODE PIPELINE"
				+ "TO HAPPLY DEPLOY OUR APPLICATION IN CLOUD PLATFORM AFTER LONG TIME TO GOT ACHIVEMENT THANKS ALL.."; 
